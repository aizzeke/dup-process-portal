(function () {
  ...
  function createTopbar() {
    if (document.querySelector(".dup-guide-topbar")) return;
    const bar = document.createElement("header");
    bar.className = "dup-guide-topbar";
    bar.innerHTML = `
      <div class="dup-guide-topbar__inner">
        <a class="dup-guide-brand" href="../" aria-label="Вернуться к процессу">
          <span class="dup-guide-brand__mark">ДУП</span>
          <span>Навигатор процессов</span>
        </a>
        <span class="dup-guide-crumb">/ Моя роль</span>
        <span class="dup-guide-topbar__spacer"></span>
        <div class="dup-guide-status" id="dup-guide-status" hidden>
          <span class="dup-guide-status__ring" id="dup-guide-status-ring"><span class="dup-guide-status__pct" id="dup-guide-status-pct">0%</span></span>
          <span class="dup-guide-status__text"><b id="dup-guide-status-title">Моя роль</b><small id="dup-guide-status-sub">Путь по процессу</small></span>
        </div>
        <button class="dup-guide-theme" type="button" id="dup-guide-theme" title="Сменить тему" aria-label="Сменить тему">◐</button>
      </div>`;
    document.body.insertBefore(bar, document.body.firstChild);

    bar.querySelector("#dup-guide-theme").addEventListener("click", () => {
